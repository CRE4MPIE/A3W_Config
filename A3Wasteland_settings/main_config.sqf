...
A3W_spawnBeaconSpawnHeight = 249; // Altitude in meters at which players will spawn when using spawn beacons (0 = ground/sea)
...
A3W_vehicleLifetime = 1*24;          // Maximum lifetime in hours for saved vehicles across server restarts, regardless of usage (0 = no time limit)
...
A3W_moneyMissionDelay = 60*60;     // Time in seconds between Money Missions
